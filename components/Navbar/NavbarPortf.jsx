    ...
    <div class="p-4 px-6 pt-6 md:mx-20 flex items-center justify-between">
      ...
      <div class="flex gap-3 sm:gap-4 md:gap-9 font-poppins text-sm sm:text-md md:text-lg">
        <button
          ...
          class="px-2 sm:px-6 py-2 ring-2 font-semibold transition ease-in-out delay-150 ring-portfLight hover:bg-portfLight text-portfLight hover:text-portfGreen rounded-full"
        >
          about
        </button>
        <button
